...
Page
{
    ...
    Item {
        ...
        Text {
            ...
            text: qsTr("### Welcome to the %1 %2 installer

This program will ask you some questions and set up %1 on your computer.").arg(Branding.string(Branding.ProductName)).arg(Branding.string(Branding.Version))
        }
        Image {
            id: welcomeImage
        ...
        Rectangle {
            ...
            Text {
                ...
                leftPadding: 5
                textFormat: Text.MarkdownText
                text: qsTr("Current Language:&nbsp;") + "**" + list1.currentItem.currentLanguage.label + "**"
            }
            Image {
